<template>
  <div class="home">
    <nav class="navbar" v-test="{id: 'navbar'}">
      <div class="menu" @click="toggleDrawer" v-test="{id: 'menu'}" data-cy='menu'>
        <icon scale="1.5" name="bars" />
      </div>
      <ul class="nav-links">
        <li class="create">
            <button class="create-button" @click="routeToCreate" v-test="{id: 'create'}" data-cy="create-button">
    ...
    <transition name="modal">
      <div class="modal" @click="toggleDrawer" v-if="drawer" v-test="{id: 'close'}"></div>
    </transition>
    <transition name="drawer">
      <div class="navigation-drawer" v-if="drawer" v-test="{id: 'navigationDrawer'}">
        ...
        <div class="list-item">
          <ul>
            ...
            <li @click="logout" v-test="{id: 'logoutButton'}" data-cy="logout">
